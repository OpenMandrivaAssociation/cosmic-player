...
Source0:        https://github.com/pop-os/cosmic-player/archive/epoch-%{version}-alpha.6/%{name}-epoch-%{version}-alpha.6.tar.gz
...
%prep
%autosetup -n %{name}-epoch-%{version}-alpha.6 -a1 -p1
mkdir .cargo
